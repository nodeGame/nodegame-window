...
(function(window, node) {
    ...
    GameWindow.prototype.getFrameName = function() {
        ...
        if (!this.frameName) {
            ...
            this.frameName = iframe ?iframe.name || iframe.id : undefined;
        }
    ...
    GameWindow.prototype.getFrameWindow = function() {
        ...
        if (!this.frameWindow) {
            iframe = this.getFrame();
            this.frameWindow = iframe ? iframe.contentWindow : undefined;
        }
    ...
    GameWindow.prototype.getFrameRoot = function() {
        ...
        if (!this.frameRoot) {
            iframe = this.getFrame();
            this.frameRoot = iframe ? iframe.parentNode : undefined;
        }
    ...
    GameWindow.prototype.generateHeader = function() {
        ...
        if (header) {
            ...
            root = document.body || document.lastElementChild;
